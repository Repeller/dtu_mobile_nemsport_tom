 ...
 * Use the [betalingsOplysningerFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class betalingsOplysningerFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment betalingsOplysningerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            betalingsOplysningerFragment().apply {
